...
{
    Console.WriteLine("Vortex No. " + item.Id);
    foreach (var item1 in item.Edges)
    {
        Console.WriteLine("Edge: " + item1);
    }
}

foreach (var item in tables)
{
    Console.WriteLine("Id: " + item.VertexId);
    Console.WriteLine("Shortest Distance From Start Node: " + item.ShortestDistanceFromFirstNode);
}
